...
namespace Server.Mobiles
{
    ...
    public class BaseCreature : Mobile, IHonorTarget, IEngravable
    {
        ...
        // GTGalone
        public virtual TimeSpan BondingDelay { get { return TimeSpan.FromSeconds(0.1); } }
        public virtual TimeSpan BondingAbandonDelay { get { return TimeSpan.FromSeconds(0.1); } }
